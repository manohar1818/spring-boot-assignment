...
<br>
<div class="container">
  <h2>Adding Article</h2><brs><br>
  <form class="form-horizsontal" action="/action_page.php">
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Title:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="title" placeholder="Enter title name" name="title"><br>
      </div>
    </div>
      ...
      <div class="col-sm-10">
        <input type="email" class="form-control" id="email" placeholder="Enter category" name="email"><br>
      </div>
    </div>
      ...
      <div class="col-sm-10">
        <input type="email" class="form-control" id="email" placeholder="Enter Description" name="email"><br>
      </div>
    </div>
      ...
      <div class="col-sm-10">
        <input type="datetime-local" class="form-control" id="email" placeholder="From date" name="email"><br>
      </div>
    </div>
        <div class="form-group">
      <label class="control-label col-sm-2" for="email">End Date:</label>
      <div class="col-sm-10">
        <input type="datetime-local" class="form-control" id="email" placeholder="To date" name="email"><br>
      </div>
    </div>
    
        <div class="form-group">
      <label class="control-label col-sm-2" for="email">Official link:</label>
      <div class="col-sm-10">
        <input type="email" class="form-control" id="email" placeholder="Enter official Link" name="email"><br>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter image link" name="pwd"><br>
      </div>
    </div>
    <div class="form-group">        
